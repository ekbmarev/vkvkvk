		...
		return (
            <View popout={this.state.popout} activePanel={this.state.activePanel}>
                <Panel id="product">
                    ...
                    <Group>
                        <Div>
                            <h1>Оригинальный Стейк Рибай с соусом </h1>
                            <HorizontalScroll>
                                <div style={{ display: 'flex' }}>
                                    <div style={{ ...itemStyle, paddingLeft: 4 }}>
                                    <Avatar size={64} style={{ marginBottom: 8 }}><Icon24Pencil /></Avatar>
                                    1 место
                                    </div>
                                    <div style={itemStyle}>
                                    <Avatar size={64} style={{ marginBottom: 8 }}><Icon24Pencil /></Avatar>
                    ...
                    <Group>
                        <Div className="product-stat">
                            <Cell description="Призов"><span>5</span></Cell>
                        </Div>   
                        <Div className="product-stat">
                ...
                <Check id="check" goBack={this.goBack}/>
            </View>
        )
    }
}
